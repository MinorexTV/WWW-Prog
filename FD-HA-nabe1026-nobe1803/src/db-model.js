export const getAllArtists = (data) => data.queryEntries('SELECT * FROM artists');

export const getArtist = (data, id) => data.queryEntries('SELECT * FROM artists WHERE artistId = $id', {$id: id});

export const addArtist = (data, newArtistData) => data.query(`
    INSERT INTO artists (name, description, time, date, picture) 
    VALUES (:name, :description,:time, :date, :picture);`, newArtistData);

export const editArtist = (data, newArtistData) => data.query(`UPDATE artists
